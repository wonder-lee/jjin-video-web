...
export default function youtube_tool() {
  return (
    <PostDetailContainer>
      ...
      도출해 내어야 합니다.
      <h3>스크립트 작성하기</h3>
      아이디어를 구상한 다음 단계는 스크립트를 작성하는 것입니다. 스크립트는
      영상의 흐름을 결정하고, 이야기를 어떻게 전달할지를 결정하는 중요한
      요소입니다.
      <h3>영상 촬영 및 편집하기</h3>
      스크립트 작성 후, 영상을 촬영하고, 촬영한 영상을 편집하는 과정을 진행하게
      됩니다. 이 과정에서는 영상의 퀄리티를 높이는 데 초점을 맞추어야 합니다.
      <h3>업로드와 SEO 최적화</h3>
      영상을 촬영하고 편집한 후에는 유튜브에 업로드하고, SEO 최적화를 진행해야
      합니다. SEO 최적화를 통해 여러분의 영상이 검색 결과 상단에 노출될 수
      있도록 해야 합니다.
      <h3>영상 마케팅 전략</h3>
      마지막으로, 영상 마케팅 전략을 구성하여, 여러분의 영상이 더 많은
      사람들에게 도달할 수 있도록 해야 합니다. 이를 통해 여러분의 영상이 더 많은
      조회수와 구독자를 얻을 수 있습니다.
      <p>conclusion</p>
      이렇게 5개의 단계를 거쳐 유튜브 영상 콘텐츠를 제작하는 방법을
      알아보았습니다. 이러한 과정을 체계적으로 따르면, 퀄리티 높은 영상 컨텐츠를
